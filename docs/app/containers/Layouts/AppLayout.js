  ...
  render() {
    ...
    return (
      <div>
        ...
        <PapperBlock
          title="App Layout with Sidebar"
          icon="ios-desktop-outline"
          desc="The Drawer slides in from the side. It is a common pattern found in Google apps and follows the keylines and metrics for lists."
        >
          <div>
            <SidebarLayout />
        ...
        <PapperBlock
          title="Full Header Mode"
          icon="ios-desktop-outline"
          desc="Apps focused on productivity that require balance across the screen."
        >
          <div>
            <FullHeader />
