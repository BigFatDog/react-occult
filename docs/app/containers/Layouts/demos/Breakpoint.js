  ...
  return (
    <div className={classes.root}>
      ...
      <Typography gutterBottom noWrap>
        Using any breakpoint up property, the given children will be hidden at
      ...
      <Typography gutterBottom noWrap>
        Using any breakpoint down property, the given children will be hidden at
      ...
      <Typography gutterBottom noWrap>
        Using the breakpoint only property, the given children will be hidden at
        the specified breakpoint(s).
      </Typography>
      <div className={classes.container}>
        <Hidden only="lg">
